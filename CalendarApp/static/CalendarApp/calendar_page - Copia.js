...
//document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendarWeek = new FullCalendar.Calendar( document.getElementById('calendar-week'), {
        ...
        validRange: customValidRange(new Date()), // Pass the current date to the function
        ...
        select: function(info) {
            ...
            $('#bookingFormModal').on('hidden.bs.modal', function () {           
                ...
                console.log("exiting with on hidden.bs.modal")
            });
        }, //select
...
function customValidRange(nowDate) {
